  ...
  const projects = [
    {
      ...
      description:
        "It was quite a big project, i was hired as a freelance contractor via codersh web services to built their mariniere colab collection page. All communications went through slack, it was quite fun to to work with two french founders and in the end it was one of my most memorable experience.",
      url: "",
    },
    {
      title: "ReinventU",
